...
WARN=-Wall -Wstrict-prototypes -Wmissing-prototypes -Wpointer-arith -Wno-sign-compare  -Wno-traditional  -Wa,--fatal-warnings -Wreturn-type -Wswitch -Wshadow -Wcast-qual -Wwrite-strings -Wextra -Wno-unused-parameter -Wno-sign-compare -Wold-style-definition -Wsign-compare -Wformat=2   -Wno-format-zero-length -Wno-clobbered  -Werror
CFLAGS=${INCLUDE} -O2 -g -fPIC -std=gnu99 ${WARN} -DLIBRUMPUSER -D_REENTRANT  -c -DGPROF -DPROF
SRCDIR=./librumpfiber
SOURCES=rumpfiber.c rumpfiber_thread.c rumpfiber_synch.c rumpfiber_stubs.c rumpuser_component.c rumpuser_dl.c rumpuser_errtrans.c rumpuser_sigtrans.c
